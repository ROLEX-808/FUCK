...
╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝
    ...
    │ [✓] WHATSAPP : +8801890384480         │

    │ [✓] POWER BY : \033[1;32m RLX RIFAT \033[1;37m           │
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mROLEX1x1\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
        ...
        sys.stdout.write(f'\r\033[m[ROLEX1x1] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
